...
public class HttpUtils {
	...
	static{
		//String certPath = session.getServletContext().getRealPath("/")+"resource/certificate/apiclient_cert.p12";
		ClassPathResource resource = new ClassPathResource("config/wxpay/apiclient_cert.p12");
		try {
			KeyStore keystore = KeyStore.getInstance("PKCS12");
			char[] keyPassword = WeiXinConfig.MCH_ID.toCharArray(); //证书密码
