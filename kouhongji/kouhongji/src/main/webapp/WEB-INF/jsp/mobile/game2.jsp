...
<script type="text/javascript" src="resource/js/bodymovin.js?v=1543302934"></script>
<!-- <script type="text/javascript" src="../addons/junsion_winaward/public/js/jweixin-1.3.0.js?v=1543302934"></script> -->
<script type="text/javascript" src="https://res.wx.qq.com/open/js/jweixin-1.3.2.js"></script>
<script type="text/javascript" src="resource/js/jquery-3.3.1.min.js?v=1543302934"></script>
<script type="text/javascript" src="resource/js/jquery.cookie.js?v=1543302934"></script>
<style>
.wx_no{
    font-size: 15px;
    display: block;
...
<body style="--wx_color:#ff27a4;--wx_color1:#ff27a4;--wx_color2:#fff1f4;">
	...
	<audio id="back_music" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/background_audio.mp3" loop="true"></audio>
	<audio id="collision_audio" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/collision_audio.wav"></audio>
	<audio id="Countdown_10s_audio" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/Countdown_10s_audio.mp3"></audio>
	<audio id="gameSuccess_audio" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/gameSuccess_audio.mp3"></audio>
	<audio id="insert_audio" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/insert_audio.mp3"></audio>
	<audio id="success_audio" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/success_audio.mp3"></audio>
	<div class="levelSwitchBox" id="levelSwitchBox" style="display: block;">
		<img id="levelSwitchBoxMain" class="levelSwitchBoxMain" src="http://p8v8q53wo.bkt.clouddn.com/khj/level_1Switch_main.png"> 
	...
	<div class="PopupBox" id="gameOverBox" style="display: none;">
		<div id="gameOverClose" class="close">
			<img src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/close_btn.jpg">
		</div>
		<div id="gameOverBoxTitle">挑战失败</div>
		<!-- <div id="gameOverBoxTime">5s</div> -->
		<div class="PopupBoxBtn" id="gameOverBoxBtn" style="margin-top:0.8rem;">重新挑战</div>
				<a class="wx_no" id="wx_no" style="display: none;">小编微信：<span></span></a>	
	</div>
	...
	<div class="layoutRoot" id="app" style="background: url(http://p8v8q53wo.bkt.clouddn.com/khj/game_bg.png);background-size: cover;background-repeat: no-repeat;">
    ...
    <div id="FailLog" style="position: absolute;top: 400px;left: 0;background-color: red;z-index: 9;font-size: 10px;">123</div> -->
		<div class="game" id="game" style="width: 375px; height: 667px;">
			<div class="bulletsNumBox">
				<img class="bulletsNum" id="bulletsNum1" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/6.png"> 
				<img class="bulletsNum" id="bulletsNum2" src="" style="display: none;">
			</div>
			...
			<div class="levelbox" id="levelbox">
				<div class="level">
					<img id="level_1" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/level_icon_1_active.png">
				</div>
				<div class="level">
					<img id="level_2" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/level_icon_2.png">
				</div>
				<div class="level">
					<img id="level_3" src="https://wx.zdslj.cn/addons/junsion_winaward/public/img/level_icon_3.png">
				</div>
			</div>
			<div id="timebox" style="background: url(resource/img/timebox.png);background-size: contain;background-repeat: no-repeat;">0</div>
		</div>
	</div>
	<script type="text/javascript">
